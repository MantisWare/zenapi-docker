      ...
      <div className={cn(this.state.boostrapCol, styles.pluginCard)}>
        <div className={styles.wrapper}>
          <div className={styles.cardTitle}>
            ...
            <div>{this.props.plugin.name} <i className='fa fa-external-link' onClick={() => window.open(`https://github.com/tysflotv/zenapi/tree/master/packages/zenapi-plugin-${this.props.plugin.id}`, '_blank')} /></div>
          </div>
          ...
          <div className={styles.cardFooter} onClick={e => e.stopPropagation()}>
            <div className={styles.cardFooterButton}>
              ...
              />
              <a
                href="https://mantisware.co.za/shop"
                style={{ display: 'none' }}
                ref={(a) => { this.aTag = a; }}
                target="_blank"
              >
