...
window.zenapi = Object.assign(window.zenapi || {}, {
  ...
  notification: {
    ...
    refresh: (message) => {
      displayNotification(message, 'refresh');
    },
  },
  refresh: (pluginId) => ({
  ...
  router: history,
  languages,
  currentLanguage: window.localStorage.getItem('zenapi-admin-language') ||  window.navigator.language ||  window.navigator.userLanguage || 'en',
  lockApp,
  unlockApp,
  injectReducer,
  injectSaga,
