...
import InputSelect from 'zenapi-helper-plugin/lib/src/components/InputSelect';
...
export class HomePage extends React.Component {
  ...
  handleSubmit = e => {
    ...
    if (isEmpty(body))
      return zenapi.notification.info('settings-manager.zenapi.notification.info.settingsEqual');
    if (isEmpty(formErrors)) {
  ...
  handleDatabaseDelete = dbName => {
    ...
    zenapi.notification.success('settings-manager.zenapi.notification.success.databaseDelete');
...
const withReducer = zenapi.injectReducer({ key: 'homePage', reducer, pluginId });
const withSaga = zenapi.injectSaga({ key: 'homePage', saga, pluginId });
