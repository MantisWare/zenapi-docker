...
module.exports = {
  ...
  application: async () => {
    const application = await zenapi.store({
      environment: '',
      type: 'core',
      key: 'application'
    }).get();
      ...
      sections: [
        {
          ...
          items: [
            ...
            },
            {
              ...
              type: 'string',
              value: _.get(zenapi.config, 'info.version', null),
              validations : {
                regex: '^(\\d+\\.)?(\\d+\\.)?(\\*|\\d+)$',
                required: true
              }
        ...
        items: [
          {
            ...
            type: 'string',
            value: _.get(zenapi.config, `environments.${env}.request.logger.level`, null),
            validations: {
              required: true
            }
          },
          {
            ...
            type: 'boolean',
            value: _.get(zenapi.config, `environments.${env}.request.logger.exposeInContext`, null),
            validations: {
              required: true
            }
          },
          {
            ...
            type: 'boolean',
            value: _.get(zenapi.config, `environments.${env}.request.logger.requests`, null),
            validations: {
              required: true
            }
          }
        ...
        items: [
          {
            ...
            type: 'boolean',
            value: _.get(zenapi.config, `environments.${env}.request.parser.enabled`, null),
            items: [
              {
                name: 'form.request.item.parser.multipart',
                target: 'request.parser.multipart',
                type: 'boolean',
                value: _.get(zenapi.config, `environments.${env}.request.parser.multipart`, null),
                validations : {
                  required: true
                }
              }
        ...
        items: [
          {
            ...
            type: 'string',
            value: _.get(zenapi.config, `environments.${env}.request.router.prefix`, null),
            validations : {
              required: true
            }
          }
        ...
        items: [
          {
            ...
            type: 'boolean',
            value: _.get(zenapi.config, `environments.${env}.response.gzip.enabled`, null),
            validations: {
              required: true
            }
          }
        ...
        items: [
          {
            ...
            type: 'boolean',
            value: _.get(zenapi.config, `environments.${env}.response.responseTime.enabled`, null),
            validations: {
              required: true
            }
          }
        ...
        items: [
          {
            ...
            type: 'boolean',
            value: _.get(zenapi.config, `environments.${env}.response.poweredBy.enabled`, null),
            items: [
              {
                name: 'form.response.item.poweredBy.value',
                target: 'response.poweredBy.value',
                type: 'string',
                value: _.get(zenapi.config, `environments.${env}.response.poweredBy.value`, null),
                validations : {
                  required: true
                }
              }
        ...
        items: [
          {
            ...
            type: 'boolean',
            value: _.get(zenapi.config, `environments.${env}.security.csrf.enabled`, null),
            items: [
              {
                name: 'form.security.item.csrf.key',
                target: 'security.csrf.key',
                type: 'string',
                value: _.get(zenapi.config, `environments.${env}.security.csrf.key`, null),
                validations: {}
              },
              {
                ...
                type: 'string',
                value: _.get(zenapi.config, `environments.${env}.security.csrf.secret`, null),
                validations: {}
              },
              {
                ...
                type: 'string',
                value: _.get(zenapi.config, `environments.${env}.security.csrf.cookie`, null),
                validations: {}
              },
              {
                ...
                type: 'boolean',
                value: _.get(zenapi.config, `environments.${env}.security.csrf.angular`, null),
                validations: {}
              }
            ],
            validations: {
        ...
        items: [
          {
            ...
            type: 'boolean',
            value: _.get(zenapi.config, `environments.${env}.security.p3p.enabled`, null),
            items: [
              {
                name: 'form.security.item.p3p.value',
                target: 'security.p3p.value',
                type: 'string',
                value: _.get(zenapi.config, `environments.${env}.security.p3p.value`, null),
                validations: {
                  required: true
                }
              }
        ...
        items: [
          {
            ...
            type: 'boolean',
            value: _.get(zenapi.config, `environments.${env}.security.hsts.enabled`, null),
            items: [
              {
                name: 'form.security.item.hsts.maxAge',
                target: 'security.hsts.maxAge',
                type: 'number',
                value: _.get(zenapi.config, `environments.${env}.security.hsts.maxAge`, null),
                validations: {
                  required: true
                }
              },
              {
                ...
                type: 'boolean',
                value: _.get(zenapi.config, `environments.${env}.security.hsts.includeSubDomains`, null),
                validations: {}
              },
              {
                ...
                type: 'boolean',
                value: _.get(zenapi.config, `environments.${env}.security.hsts.preload`, null),
                validations: {}
              }
            ],
            validations: {
        ...
        items: [
          {
            ...
            type: 'boolean',
            value: _.get(zenapi.config, `environments.${env}.security.xframe.enabled`, null),
            items: [
              {
                name: 'form.security.item.xframe.value',
                target: 'security.xframe.value',
                type: 'enum',
                value: _.get(zenapi.config, `environments.${env}.security.xframe.value`, null),
                items: [
                  {
        ...
        items: [
          {
            ...
            type: 'boolean',
            value: _.get(zenapi.config, `environments.${env}.security.xssProtection.enabled`, null),
            items: [
              {
                name: 'form.security.item.xssProtection.mode',
                target: 'security.xssProtection.mode',
                type: 'string',
                value: _.get(zenapi.config, `environments.${env}.security.xssProtection.mode`, null),
                validations: {}
              }
            ],
            validations: {
        ...
        items: [
          {
            ...
            type: 'boolean',
            value: _.get(zenapi.config, `environments.${env}.security.cors.enabled`, null),
            items: [
              {
                name: 'form.security.item.cors.origin',
                target: 'security.cors.origin',
                type: 'string',
                value: _.get(zenapi.config, `environments.${env}.security.cors.origin`, null),
                validations: {
                  required: true
                }
              }
        ...
        items: [
          {
            ...
            target: 'server.host',
            type: 'string',
            value: _.get(zenapi.config, `environments.${env}.server.host`, null),
            validations: {}
          },
          {
            ...
            target: 'server.port',
            type: 'number',
            value: _.get(zenapi.config, `environments.${env}.server.port`, null),
            validations: {}
          },
          {
            ...
            type: 'boolean',
            value: _.get(zenapi.config, `environments.${env}.server.cron.enabled`, null)
          }
        ]
      },
      {
        ...
        items: [
          {
            ...
            type: 'boolean',
            value: _.get(zenapi.config, `environments.${env}.server.proxy.enabled`, null),
            items: [
              {
                name: 'form.server.item.proxy.host',
                target: 'server.proxy.host',
                type: 'string',
                value: _.get(zenapi.config, `environments.${env}.server.proxy.host`, null),
                validations: {}
              },
              {
                ...
                type: 'number',
                value: _.get(zenapi.config, `environments.${env}.server.proxy.port`, null),
                validations: {}
              },
              {
                ...
                type: 'boolean',
                value: _.get(zenapi.config, `environments.${env}.server.proxy.ssl`, null),
                validations: {}
              }
            ],
            validations: {}
        ...
        items: [
          {
            ...
            type: 'select',
            items: zenapi.plugins['settings-manager'].services.languages
          }
        ]
      }
    ]
    ...
    sections: [
      {
        ...
        items: [
          ...
          },
          {
            ...
            type: 'string',
            value: _.get(zenapi.config, `environments.${env}.database.connections.${name}.connector`, null),
            validations: {
              required: true
            }
          },
          {
            ...
            type: 'select',
            value: _.get(zenapi.config, `environments.${env}.database.connections.${name}.settings.client`, null),
            items: [
              {
          ...
          },
          {
            ...
            type: 'string',
            value: _.get(zenapi.config, `environments.${env}.database.connections.${name}.settings.host`, null),
            validations: {
              required: true
            }
          },
          {
            ...
            type: 'number',
            value: _.get(zenapi.config, `environments.${env}.database.connections.${name}.settings.port`, null),
            validations: {
              required: true
            }
          },
          {
            ...
            type: 'string',
            value: _.get(zenapi.config, `environments.${env}.database.connections.${name}.settings.database`, null),
            validations: {
              required: true
            }
          },
          {
            ...
            type: 'string',
            value: _.get(zenapi.config, `environments.${env}.database.connections.${name}.settings.username`, null),
            validations: {}
          },
          {
            ...
            type: 'password',
            value: _.get(zenapi.config, `environments.${env}.database.connections.${name}.settings.password`, null),
            validations: {}
          },
          {
            ...
            type: 'string',
            value: _.get(zenapi.config, `environments.${env}.database.connections.${name}.options.authenticationDatabase`, null),
            validations: {}
          },
          {
            ...
            type: 'boolean',
            value: [true, 'true'].includes(_.get(zenapi.config, `environments.${env}.database.connections.${name}.options.ssl`, false)),
            validations: {}
          },
        ]
      },
        ...
        items: [
          {
            ...
            type: 'string',
            value: _.get(zenapi.config, `environments.${env}.database.defaultConnection`, null),
            validations: {
              required: true
            }
          }
  ...
  getEnvironments: () => {
    return _.map(_.keys(zenapi.config.environments), environment => {
      return {
        name: environment,
  ...
  getLanguages: () => {
    return _.map(zenapi.config.language.locales, language => {
      return {
        name: language,
        active: (zenapi.config.language.defaultLocale === language)
      };
    });
  },
  ...
  getDatabases: env => {
    ...
    const databasesUsed = [];
    _.forEach(zenapi.models, model => {
      databasesUsed.push(model.connection);
    });

    _.forEach(zenapi.config.environments[env].database.connections, (connection, name) =>  databases.push({
      connector: _.get(connection, 'connector'),
      letter: zenapi.plugins['settings-manager'].services.settingsmanager.getClientLetter(_.get(connection, 'settings.client')),
      color: zenapi.plugins['settings-manager'].services.settingsmanager.getClientColor(_.get(connection, 'settings.client')),
      name,
      host: _.get(connection, 'settings.host'),
      database: _.get(connection, 'settings.database'),
      active: (_.get(zenapi.config, `environments.${env}.database.defaultConnection`) === name),
  ...
  getClientConnector: client => {
    ...
    let connector;
    if (_.indexOf(bookshelfClients, client) !== -1) connector = 'zenapi-hook-bookshelf';
    if (_.indexOf(mongooseClients, client) !== -1) connector = 'zenapi-hook-mongoose';
    if (_.indexOf(redisClients, client) !== -1) connector = 'zenapi-hook-redis';
  ...
  updateSettings: async (params, items, env = '') => {
    const appPath = zenapi.config.appPath;
    const errors = [];
  ...
  installDependency: (params, name) => {
    ...
    const installedClient = _.indexOf(_.keys(zenapi.config.info.dependencies), client) !== -1;
    const connector = _.get(params, `database.connections.${name}.connector`);
    const installedConnector = _.indexOf(_.keys(zenapi.config.info.dependencies), connector) !== -1;

    if (connector && !installedConnector) {
      zenapi.log.info(`Installing ${connector} dependency ...`);
      shell.exec(`npm install ${connector}@${zenapi.config.info.zenapi}`, {silent: true});
    }

    if (client && !installedClient) {
      zenapi.log.info(`Installing ${client} dependency ...`);
      shell.exec(`npm install ${client}`, {silent: true});
    }
  },

  cleanDependency: (env, config) => {
    const availableConnectors = ['zenapi-hook-mongoose', 'zenapi-hook-bookshelf', 'zenapi-hook-redis'];
    let usedConnectors = [];
    const errors = [];

    _.forEach(_.keys(zenapi.config.environments), environment => {
      let connections = zenapi.config.environments[environment].database.connections;
    ...
    _.forEach(availableConnectors, connector => {
      const installed = _.indexOf(_.keys(zenapi.config.info.dependencies), connector) !== -1;
      const used = _.indexOf(usedConnectors, connector) !== -1;

      if (installed && !used) {
        const filePath = path.join(zenapi.config.appPath, 'package.json');
  ...
  getModelPath: model => {
    ...
    const apiPath = path.join(zenapi.config.appPath, 'api');
