...
describe('appReducer', () => {
  ...
  it('should handle the addAttributeRelation action correctly if the target is equal the current model and the relation is manyToMany', () => {
    state = state
      .setIn(['newContentType', 'name'], 'test')
      .setIn(['temporaryAttributeRelation', 'name'], 'zenapi')
      .setIn(['temporaryAttributeRelation', 'key'], 'notzenapi')
    ...
    const expected = state
      .setIn(
        ['newContentType', 'attributes', 'zenapi'],
        Map({
          dominant: true,
          columnName: '',
          targetColumnName: '',
      ...
      .setIn(
        ['newContentType', 'attributes', 'notzenapi'],
        Map({
          dominant: false,
          columnName: '',
          targetColumnName: '',
  ...
  it('should handle the deleteModelAttribute action correctly if the attribute has a relation with itself that is not oneWay', () => {
    const keys = ['modifiedData', 'product', 'attributes', 'zenapi'];
    state = state
      .setIn(
        ['modifiedData', 'product', 'attributes', 'zenapi'],
        Map({
          dominant: true,
          columnName: '',
          targetColumnName: '',
      ...
      .setIn(
        ['modifiedData', 'product', 'attributes', 'notzenapi'],
        Map({
          dominant: false,
          columnName: '',
          targetColumnName: '',
    ...
    const expected = state
      .removeIn(['modifiedData', 'product', 'attributes', 'zenapi'])
      .removeIn(['modifiedData', 'product', 'attributes', 'notzenapi']);
  ...
  it('should handle the deleteModelAttribute action correctly if the attribute has a relation with itself that is oneWay', () => {
    ...
    const expected = state.removeIn(['modifiedData', 'product', 'attributes', 'zenapi']);
  ...
  it('should handle the onChangeRelationNature action correctly for the manyToMany', () => {
    ...
    const expected = state
      ...
      .setIn(['temporaryAttributeRelation', 'dominant'], true)
      .setIn(['temporaryAttributeRelation', 'nature'], 'manyToMany')
      .setIn(['temporaryAttributeRelation', 'key'], 'zenapis');

    expect(appReducer(state, onChangeRelationNature('manyToMany', 'zenapi'))).toEqual(expected);
  });
  ...
  it('should handle the onChangeRelationNature action correctly for the manyToOne', () => {
    ...
    expect(appReducer(state, onChangeRelationNature('manyToOne', 'zenapi'))).toEqual(expected);
  });
  ...
  it('should handle the onChangeRelationNature action correctly for the oneToMany', () => {
    ...
    const expected = state
      .setIn(['temporaryAttributeRelation', 'name'], 'tests')
      .setIn(['temporaryAttributeRelation', 'nature'], 'oneToMany')
      .setIn(['temporaryAttributeRelation', 'key'], 'zenapi');

    expect(appReducer(state, onChangeRelationNature('oneToMany', 'zenapi'))).toEqual(expected);
  });
  ...
  it('should handle the onChangeRelationTarget action correctly for the manyToMany', () => {
    ...
    const expected = state
      .setIn(['temporaryAttributeRelation', 'target'], 'zenapi')
      .setIn(['temporaryAttributeRelation', 'key'], 'soupettes')
      .setIn(['temporaryAttributeRelation', 'name'], 'zenapis');

    expect(
      appReducer(state, onChangeRelationTarget({ name: 'zenapi', source: null }, 'soupette', false)),
    ).toEqual(expected);
  });
